      ...
      <div className="relative m-6 md:max-h-fit md:min-h-fit md:mt-24 md:bg-white md:px-32 md:pt-6 md:pb-16 md:shadow-xl md:rounded-xl">
        ...
        <div className="flex flex-col gap-4 md:text-center">
          ...
          <p className="overflow-hidden">
            You must ensure that the property is clean, well-maintained, and in
            good working order prior to each guest's arrival. Specifically:
            <br />
            The interior and exterior of the property should be presented in a
            condition that meets or exceeds the expectations set by the listing.
            Broken appliances, malfunctioning amenities, or unsafe conditions
            should be addressed immediately.
            <br />
            Any issues that arise during a guest’s stay should be addressed
            promptly. As a host, you should either be available to respond to
            guest concerns or provide contact information for a local
            representative who can assist with emergencies or repairs.
          </p>
        </div>
