...
const ReviewsPage = ({ params }: { params: { id: string } }) => {
  ...
  const [sortOrder, setSortOrder] = useState<"recent" | "highest" | "lowest">(
    "recent"
  ); // Limit sortOrder to those 3 values
    ...
    <div className="flex justify-center min-h-[calc(100vh-256px)] mx-auto max-w-4xl mb-24 md:mb-0">
      <div className="relative m-6 md:mt-24 w-full">
        ...
        {isModalOpen && (
          ...
          >
            <div
              className="flex flex-col gap-8 bg-white px-12 pb-12 pt-6 rounded-lg shadow-lg max-w-sm w-full"
              ...
              <div className="flex items-center gap-2">
                <div className="flex gap-1">
                  {Array(review.rating).fill(
                    <IoStarOutline
                      size={"15"}
                      className="bg-black text-white p-0.5 rounded-sm"
                    />
                  )}
                </div>
                <span>•</span>
